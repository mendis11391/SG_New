    ...
    <div class="container privacy-terms">
        <div class="row">
            <div class="col-md-12">
                ...
                The main objective of S G Testing Institute is to provide best quality training in Selenium,WebServices which enable bridge the gap between academia and corporate.
                </p>
                <p> &nbsp; </p>
            </div>
        </div>
